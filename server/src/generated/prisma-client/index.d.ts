...
export type HolePattern = "SIXTEEN" | "TWENTY" | "THIRTY";
...
export interface FlightControllerUpdateInput {
  ...
  fiveVoltOutput?: Maybe<Float>;
  eightVoltOutput?: Maybe<Float>;
  nineVoltOutput?: Maybe<Float>;
  onBoardFlash?: Maybe<Int>;
  sdCardSlot?: Maybe<Boolean>;
  fourInOneConnector?: Maybe<Boolean>;
  currentSensorRating?: Maybe<Float>;
  maxCurrent?: Maybe<Float>;
  holeSize?: Maybe<HoleSize>;
}
...
export interface FlightControllerWhereInput {
  ...
  uarts_gte?: Maybe<Int>;
  gyroOne?: Maybe<Gyro>;
  gyroOne_not?: Maybe<Gyro>;
  gyroOne_in?: Maybe<Gyro[] | Gyro>;
  gyroOne_not_in?: Maybe<Gyro[] | Gyro>;
  gyroTwo?: Maybe<Gyro>;
  gyroTwo_not?: Maybe<Gyro>;
  gyroTwo_in?: Maybe<Gyro[] | Gyro>;
  gyroTwo_not_in?: Maybe<Gyro[] | Gyro>;
  weightInGrams?: Maybe<Float>;
  ...
  cpu?: Maybe<CPU>;
  cpu_not?: Maybe<CPU>;
  cpu_in?: Maybe<CPU[] | CPU>;
  cpu_not_in?: Maybe<CPU[] | CPU>;
  description?: Maybe<String>;
  ...
  holePattern?: Maybe<HolePattern>;
  holePattern_not?: Maybe<HolePattern>;
  holePattern_in?: Maybe<HolePattern[] | HolePattern>;
  holePattern_not_in?: Maybe<HolePattern[] | HolePattern>;
  voltageInputMin?: Maybe<Float>;
  ...
  barometer?: Maybe<Baro>;
  barometer_not?: Maybe<Baro>;
  barometer_in?: Maybe<Baro[] | Baro>;
  barometer_not_in?: Maybe<Baro[] | Baro>;
  spektrumPort?: Maybe<Boolean>;
  ...
  pdb?: Maybe<Boolean>;
  pdb_not?: Maybe<Boolean>;
  threeVoltOutput?: Maybe<Float>;
  threeVoltOutput_not?: Maybe<Float>;
  threeVoltOutput_in?: Maybe<Float[] | Float>;
  threeVoltOutput_not_in?: Maybe<Float[] | Float>;
  threeVoltOutput_lt?: Maybe<Float>;
  threeVoltOutput_lte?: Maybe<Float>;
  threeVoltOutput_gt?: Maybe<Float>;
  threeVoltOutput_gte?: Maybe<Float>;
  fiveVoltOutput?: Maybe<Float>;
  fiveVoltOutput_not?: Maybe<Float>;
  fiveVoltOutput_in?: Maybe<Float[] | Float>;
  fiveVoltOutput_not_in?: Maybe<Float[] | Float>;
  fiveVoltOutput_lt?: Maybe<Float>;
  fiveVoltOutput_lte?: Maybe<Float>;
  fiveVoltOutput_gt?: Maybe<Float>;
  fiveVoltOutput_gte?: Maybe<Float>;
  eightVoltOutput?: Maybe<Float>;
  eightVoltOutput_not?: Maybe<Float>;
  eightVoltOutput_in?: Maybe<Float[] | Float>;
  eightVoltOutput_not_in?: Maybe<Float[] | Float>;
  eightVoltOutput_lt?: Maybe<Float>;
  eightVoltOutput_lte?: Maybe<Float>;
  eightVoltOutput_gt?: Maybe<Float>;
  eightVoltOutput_gte?: Maybe<Float>;
  nineVoltOutput?: Maybe<Float>;
  nineVoltOutput_not?: Maybe<Float>;
  nineVoltOutput_in?: Maybe<Float[] | Float>;
  nineVoltOutput_not_in?: Maybe<Float[] | Float>;
  nineVoltOutput_lt?: Maybe<Float>;
  nineVoltOutput_lte?: Maybe<Float>;
  nineVoltOutput_gt?: Maybe<Float>;
  nineVoltOutput_gte?: Maybe<Float>;
  onBoardFlash?: Maybe<Int>;
  onBoardFlash_not?: Maybe<Int>;
  onBoardFlash_in?: Maybe<Int[] | Int>;
  onBoardFlash_not_in?: Maybe<Int[] | Int>;
  onBoardFlash_lt?: Maybe<Int>;
  onBoardFlash_lte?: Maybe<Int>;
  onBoardFlash_gt?: Maybe<Int>;
  onBoardFlash_gte?: Maybe<Int>;
  sdCardSlot?: Maybe<Boolean>;
  sdCardSlot_not?: Maybe<Boolean>;
  fourInOneConnector?: Maybe<Boolean>;
  fourInOneConnector_not?: Maybe<Boolean>;
  currentSensorRating?: Maybe<Float>;
  currentSensorRating_not?: Maybe<Float>;
  currentSensorRating_in?: Maybe<Float[] | Float>;
  currentSensorRating_not_in?: Maybe<Float[] | Float>;
  currentSensorRating_lt?: Maybe<Float>;
  currentSensorRating_lte?: Maybe<Float>;
  currentSensorRating_gt?: Maybe<Float>;
  currentSensorRating_gte?: Maybe<Float>;
  maxCurrent?: Maybe<Float>;
  maxCurrent_not?: Maybe<Float>;
  maxCurrent_in?: Maybe<Float[] | Float>;
  maxCurrent_not_in?: Maybe<Float[] | Float>;
  maxCurrent_lt?: Maybe<Float>;
  maxCurrent_lte?: Maybe<Float>;
  maxCurrent_gt?: Maybe<Float>;
  maxCurrent_gte?: Maybe<Float>;
  holeSize?: Maybe<HoleSize>;
  holeSize_not?: Maybe<HoleSize>;
  holeSize_in?: Maybe<HoleSize[] | HoleSize>;
  holeSize_not_in?: Maybe<HoleSize[] | HoleSize>;
...
export interface FlightControllerPromise
  ...
  fiveVoltOutput: () => Promise<Float>;
  eightVoltOutput: () => Promise<Float>;
  nineVoltOutput: () => Promise<Float>;
  onBoardFlash: () => Promise<Int>;
  sdCardSlot: () => Promise<Boolean>;
  fourInOneConnector: () => Promise<Boolean>;
  currentSensorRating: () => Promise<Float>;
  maxCurrent: () => Promise<Float>;
  holeSize: () => Promise<HoleSize>;
}
...
export interface FlightControllerSubscription
  ...
  fiveVoltOutput: () => Promise<AsyncIterator<Float>>;
  eightVoltOutput: () => Promise<AsyncIterator<Float>>;
  nineVoltOutput: () => Promise<AsyncIterator<Float>>;
  onBoardFlash: () => Promise<AsyncIterator<Int>>;
  sdCardSlot: () => Promise<AsyncIterator<Boolean>>;
  fourInOneConnector: () => Promise<AsyncIterator<Boolean>>;
  currentSensorRating: () => Promise<AsyncIterator<Float>>;
  maxCurrent: () => Promise<AsyncIterator<Float>>;
  holeSize: () => Promise<AsyncIterator<HoleSize>>;
}
